...
KAFKA_LISTENERS=PLAINTEXT://:9292,SSL://:9293,INTERNAL_PLAINTEXT://:9294
...
KAFKA_SSL_KEYSTORE_LOCATION=/opt/apache/kafka/jarry_dk/broker2.jarry.dk.keystore.jks
KAFKA_SSL_KEYSTORE_PASSWORD=password1234

KAFKA_SSL_CLIENT_AUTH=requested

KAFKA_ADVERTISED_LISTENERS=PLAINTEXT://broker2.jarry.dk:9292,SSL://broker2.jarry.dk:9293,INTERNAL_PLAINTEXT://broker2.jarry.dk:9294
KAFKA_BROKER_ID=2
KAFKA_LOG_DIRS=/tmp/kafka-logs-broker-2
