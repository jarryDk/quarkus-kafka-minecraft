...
Open this file `/opt/minecraft/forge/.minecraft_1.19.3-44.1.23/libraries/net/minecraftforge/forge/1.19.3-44.1.23/unix_args.txt` and append this to `-DlegacyClassPath=`
...
We do need to add the jar files to the folder `/opt/minecraft/forge/.minecraft_1.19.3-44.1.23/mods` - I use the script link:minecraft-kafka-mod/deploy.sh[deploy.sh]
