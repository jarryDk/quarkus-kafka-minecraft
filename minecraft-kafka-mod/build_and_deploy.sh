...
FORGE_SERVER_VERSION=1.19.3-44.1.21
...
if [ ! -f $FORGE_MOD_FOLDER/kafka-clients-3.3.1.jar ]; then
    cp -v libs/kafka-clients-3.3.1.jar $FORGE_MOD_FOLDER/kafka-clients-3.3.1.jar
    ...
    cp -v libs/jackson-annotations-2.14.1.jar $FORGE_MOD_FOLDER/jackson-annotations-2.14.1.jar
    cp -v libs/jackson-core-2.14.1.jar $FORGE_MOD_FOLDER/jackson-core-2.14.1.jar
    cp -v libs/jackson-databind-2.14.1.jar $FORGE_MOD_FOLDER/jackson-databind-2.14.1.jar
else
    echo "kafka-clients-3.3.1.jar was in the folder : $FORGE_MOD_FOLDER"
fi
